    ...
    execute(client, message) {
        let button = new MessageActionRow().addComponents(
            ...
            .setCustomId("del"))
                ...
                .setFooter({ text: 'Batry  ❤️', iconURL:message.author.avatarURL({ dynamic: true }) })
                .setDescription(`**
            > Sunucu: \`${client.guilds.cache.size}\`
            > Kullanıcı: \`${Math.ceil(client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString("tr-TR"))}\`
